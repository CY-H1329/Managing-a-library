...
//QUESTION 2.6
//Fonction pour lire n lignes d'un fichier et les stock dans le format numéro, titre et auteur
...
//Fonction pour enregistrer une bibliothèque dans un fichier dans le format numéro, titre et auteur 
